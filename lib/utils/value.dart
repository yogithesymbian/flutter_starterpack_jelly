...
const kApiUri = 'http://192.168.248.190:3001';
const kBearer = 'bearer';
const kEmail = 'email';
const kPass = 'password';

const kDebugSound = 'debug puzzle_sound';
const kDebugDrag = 'debug puzzle_drag';
const kDebugBool = 'debug puzzle_boolean';
